...
<div class="container">
    ...
    <div style="width: 100%">
        ...
        <div style="display: inline-block">
            <span style="text-align: right"> <a href="${pageContext.request.contextPath}/coinBuyer/findByUid?id=${user.id}">我的订单</a></span>
        </div>
    </div>
    <br>
    <hr class="hr1">
    ...
    <div class="box demo2">
        <ul class="tab_menu">
            <li class="current">求购市场</li>
            <li><a href="${pageContext.request.contextPath}/do/showAllSeller" style="color: #0f0f0f">卖场</a></li>
        </ul>
        <div class="tab_box">
            <div>
                <div class="trade">
                ...
                <div id="need_list">
                    <ul>
                        <c:forEach items="${buyers}" var="buyer">
                            <form action="${pageContext.request.contextPath}/user/trade">
                                <c:if test="${buyer.tradeNum != 0}">
                                    <li style="height: 150px;background-color:snow;border-radius: 5px;border-radius: 10px;margin: 10px 0px">
                                        <div style="height: 100%;" id="listIn">

                                            <div style="width: 20%;">
                                                <img name="uimg" src="${buyer.user.uimg}"
                                                     style="width: 100%;height: 100%">
                                            </div>
                                            <div style="width: 60%">

                                                <p class="username">${buyer.user.username}</p>
                                                <p id="needNum">求购数量：${buyer.tradeNum}</p>
                                                <input type="hidden" name="tradeNum" value="${buyer.tradeNum}">
                                                <input type="hidden" name="iid" value="${buyer.iid}">
                                                <input type="hidden" name="user.username"
                                                       value="${buyer.user.username}">
                                                <input type="hidden" name="tradePrice" value="${buyer.tradePrice}">
                                                <input type="hidden" name="user.phoneNum"
                                                       value="${buyer.user.phoneNum}">
                                                <input type="hidden" name="user.id" value="${buyer.user.id}">
                                                <p id="needPrice">单价：￥${buyer.tradePrice}</p>
                                            </div>
                                            <div style="width: 19%;margin: 0px;padding: 0px">
                                                <input type="submit" name="" id="sell_inp" value="卖给他"
                    ...
                    <ul>
                        <li style="height: 150px">
                            <div style="height: 100%">
                                ...
                                <div style="width: 19%;margin: 0px;padding: 0px">
                                    <input type="button" name="" id="buy_inp" value="卖给他"
                                           style="width: 60%; float: right">
                                    <img src="/img/market/pay.png" alt="" style="width: 20px;height: 20px">
                                </div>
                            </div>
    ...
    <div id="bottom">
        <ul style="list-style: none" class="ul_list">
            ...
            <li>
                <div class="icon"><a href="${pageContext.request.contextPath}/life.jsp" class=""><img
