...
<div class="box demo2  ">
    ...
    <br>
    <ul class="tab_menu">
        <li class="current"  onclick="location.href = '${pageContext.request.contextPath}/coinBuyer/findByUid?id=${user.id}'">求购订单</li>
        <li onclick="location.href = '${pageContext.request.contextPath}/order/findByUid?id=${user.id}'">交易订单</li>
    </ul>
    <div    class="tab_box">
        <div>
            <ul>
